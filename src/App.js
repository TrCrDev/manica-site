  ...
  return (
    <div className="App">
      ...
      <div className="concept-section">
        ...
        <img src="1.png" alt="" className="centered-image" />
      </div>
      ...
      <div className="rdv-section">
        <img src="rdv-title.svg" alt="" className="rdv-image" />
        <p className="description">
      ...
      <div className="showroom-section">
        <img src="showroom-title.svg" alt="" className="showroom-image" />
        <p className="description">
      ...
      <div className="concept-section">
        ...
        <br></br><br></br>
        <img src="6.png" alt="" className="centered-image" />
      </div>
      ...
      <div className="concept-section">
        ...
        <img src="ny.svg" alt="" className="small-centered-image" />
        <p className="description">
        ...
        <img src="9.png" alt="" className="centered-image" />


        <img src="yv.svg" alt="" className="small-centered-image" />
        <p className="description">
        ...
        <img src="10.png" alt="" className="centered-image" />


        <img src="my.svg" alt="" className="small-centered-image" />
        <p className="description">
        Un grand MERCI à MANICA d’avoir réalisé ma magnifique robe de mariée sur mesure et personnalisée.<br></br>
        Un accompagnement au top, de la confection de la robe, du choix du tissu jusqu’au jour du mariage, j’ai eu de la chance de l’avoir à mes côtés.<br></br>
        Ma robe a fait son effet et j’en suis encore très reconnaissante.
        ...
        <img src="11.png" alt="" className="centered-image" />



        <img src="la.svg" alt="" className="small-centered-image" />
        <p className="description">
        MANICA c’est avant tout une très belle rencontre...
        Passionnée par son métier et ultra douée pour donner vie à la robe que j’avais imaginé.<br></br>
        Des échanges et conseils sur la création, en passant par la prise de mesures, le suivi de la fabrication à l’atelier, jusqu’à l’essayage, tout à été parfait !<br></br>
        ...
        <img src="12.png" alt="" className="centered-image" />



        <img src="lo.svg" alt="" className="small-centered-image" />
        <p className="description">
        ...
        <img src="13.png" alt="" className="centered-image" />




        <img src="ju.svg" alt="" className="small-centered-image" />
        <p className="description">
        ...
        <img src="14.png" alt="" className="centered-image" />




        <img src="el.svg" alt="" className="small-centered-image" />
        <p className="description">
