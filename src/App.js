  ...
  return (
    <div className="App">
      ...
      <div className="main-content">
        <img src="intro.svg" alt="" className="title-image" data-aos="fade-up" data-aos-duration="2000"/>
      </div>
      ...
      <div className="concept-section">
        <img src="1st.svg" alt="" className="title-image" data-aos="fade-up" data-aos-duration="2000" />
        ...
        <img src="1.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="800" />
      </div>
      ...
      <div className="concept-section">
        <img src="2nd.svg" alt="" className="title-image2" data-aos="fade-up" data-aos-duration="2000" />
        <div className="description">
          <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400" >
        ...
        <img src="2.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000" />
      </div>
      ...
      <div className="rdv-section">
        <img src="rdv-title.svg" alt="" className="rdv-image" data-aos="fade-up" data-aos-duration="2000" />
        <div className="description">
          <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400" >
      ...
      <div className="showroom-section">
        <img src="showroom-title.svg" alt="" className="showroom-image"data-aos="fade-up" data-aos-duration="2000" />
        <div className="description">
          <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400" >
      ...
      <div className="img-section">
        <img src="3.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="600"  />
      </div>
      ...
      <div className="concept-section">
        <img src="3rd.svg" alt="" className="title-image2" data-aos="fade-up" data-aos-duration="2000"  />
        <div className="description">
      ...
      <div className="concept-section">
        <img src="4th.svg" alt="" className="title-image2" data-aos="fade-up" data-aos-duration="2000"  />
        <div className="description">
        <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400"  >
        ...
        <img src="5.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000" />
        <br></br><br></br>
        <img src="6.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000" />
      </div>
      ...
      <div className="concept-section">
        <img src="5th.svg" alt="" className="title-image3" data-aos="fade-up" data-aos-duration="2000"  />
        <div className="space-50px"></div>
        <img src="7.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000"  />
        <div className="description">
        ...
        <img src="6th.svg" alt="" className="title-image2" data-aos="fade-up" data-aos-duration="2000"  />
      ...
      <div className="concept-section">
        ...
        <p className="description" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
        ...
        <img src="9.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000"  />


        <img src="yv.svg" alt="" className="small-centered-image" data-aos="fade-up" data-aos-duration="2000"  />
        <p className="description" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
        ...
        <img src="10.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000"  />


        <img src="my.svg" alt="" className="small-centered-image" data-aos="fade-up" data-aos-duration="2000"  />
        <p className="description" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
        Un grand MERCI à MANICA d’avoir réalisé ma magnifique robe de mariée sur mesure et personnalisée.<br></br>
        Un accompagnement au top, de la confection de la robe, du choix du tissu jusqu’au jour du mariage, j’ai eu de la chance de l’avoir à mes côtés.<br></br>
        Ma robe a fait son effet et j’en suis encore très reconnaissante.
        ...
        <img src="11.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000"  />



        <img src="la.svg" alt="" className="small-centered-image" data-aos="fade-up" data-aos-duration="2000"  />
        <p className="description" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
        MANICA c’est avant tout une très belle rencontre...
        Passionnée par son métier et ultra douée pour donner vie à la robe que j’avais imaginé.<br></br>
        Des échanges et conseils sur la création, en passant par la prise de mesures, le suivi de la fabrication à l’atelier, jusqu’à l’essayage, tout à été parfait !<br></br>
        ...
        <img src="12.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000" />



        <img src="lo.svg" alt="" className="small-centered-image" data-aos="fade-up" data-aos-duration="2000"  />
        <p className="description" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
        ...
        <img src="13.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000"  />




        <img src="ju.svg" alt="" className="small-centered-image" data-aos="fade-up" data-aos-duration="2000"  />
        <p className="description" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
        ...
        <img src="14.png" alt="" className="centered-image" data-aos="fade-up" data-aos-duration="2000"  />




        <img src="el.svg" alt="" className="small-centered-image" data-aos="fade-up" data-aos-duration="2000" />
        <p className="description" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
      ...
      <div className="concept-section" data-aos="fade-up" data-aos-duration="2000" >
        <img src="8th.svg" alt="" className="title-image3" />
        <div className="space-50px"></div>
        <img src="help.svg" alt="" className="desc-image" data-aos="fade-up" data-aos-duration="2000"/>
